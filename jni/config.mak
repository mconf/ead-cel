...
SRC_PATH="/home/giancarlo/workspace/eadcel2testesendffmpegaudio/jni"
SRC_PATH_BARE=/home/giancarlo/workspace/eadcel2testesendffmpegaudio/jni
BUILD_ROOT="/home/giancarlo/workspace/eadcel2testesendffmpegaudio/jni"
ARCH=arm
CC=/home/giancarlo/android-ndk-r4-crystax/build/prebuilt/linux-x86/arm-eabi-4.4.0/bin/arm-eabi-gcc
AS=/home/giancarlo/android-ndk-r4-crystax/build/prebuilt/linux-x86/arm-eabi-4.4.0/bin/arm-eabi-gcc
LD=/home/giancarlo/android-ndk-r4-crystax/build/prebuilt/linux-x86/arm-eabi-4.4.0/bin/arm-eabi-gcc
DEPCC=/home/giancarlo/android-ndk-r4-crystax/build/prebuilt/linux-x86/arm-eabi-4.4.0/bin/arm-eabi-gcc
YASM=yasm
YASMDEP=yasm
AR=arm-eabi-ar
...
CPPFLAGS= --sysroot=/home/giancarlo/android-ndk-r4-crystax/build/platforms/android-5/arch-arm -D_ISOC99_SOURCE -D_POSIX_C_SOURCE=200112 -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -DPIC
CFLAGS= -I/home/giancarlo/android-ndk-r4-crystax/build/platforms/android-5/arch-arm/usr/include -fpic -mthumb-interwork -ffunction-sections -funwind-tables -fstack-protector -fno-short-enums -D__ARM_ARCH_5__ -D__ARM_ARCH_5T__ -D__ARM_ARCH_5E__ -D__ARM_ARCH_5TE__ -DANDROID -march=armv5te -mtune=xscale -msoft-float -O2 -fomit-frame-pointer -fstrict-aliasing -funswitch-loops -finline-limit=300  -std=c99 -fomit-frame-pointer -fPIC -marm -g -Wdeclaration-after-statement -Wall -Wno-switch -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wno-pointer-sign -Wcast-qual -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=implicit -Werror=missing-prototypes
ASFLAGS= -I/home/giancarlo/android-ndk-r4-crystax/build/platforms/android-5/arch-arm/usr/include -fpic -mthumb-interwork -ffunction-sections -funwind-tables -fstack-protector -fno-short-enums -D__ARM_ARCH_5__ -D__ARM_ARCH_5T__ -D__ARM_ARCH_5E__ -D__ARM_ARCH_5TE__ -DANDROID -march=armv5te -mtune=xscale -msoft-float -O2 -fomit-frame-pointer -fstrict-aliasing -funswitch-loops -finline-limit=300  -fPIC -g
CC_O=-o $@
LDFLAGS=  -nostdlib -Bdynamic -Wl,-rpath-link=/home/giancarlo/android-ndk-r4-crystax/build/platforms/android-5/arch-arm/usr/lib -L/home/giancarlo/android-ndk-r4-crystax/build/platforms/android-5/arch-arm/usr/lib -Wl,-T,/home/giancarlo/android-ndk-r4-crystax/build/prebuilt/linux-x86/arm-eabi-4.4.0/arm-eabi/lib/ldscripts/armelf.x -Wl,-dynamic-linker,/system/bin/linker -Wl,--gc-sections -Wl,-z,nocopyreloc /home/giancarlo/android-ndk-r4-crystax/build/platforms/android-5/arch-arm/usr/lib/crtbegin_dynamic.o /home/giancarlo/android-ndk-r4-crystax/build/prebuilt/linux-x86/arm-eabi-4.4.0/lib/gcc/arm-eabi/4.4.0/libgcc.a /home/giancarlo/android-ndk-r4-crystax/build/platforms/android-5/arch-arm/usr/lib/crtend_android.o -lc --sysroot=/home/giancarlo/android-ndk-r4-crystax/build/platforms/android-5/arch-arm -Wl,--warn-common -Wl,--as-needed -Wl,-rpath-link,$(BUILD_ROOT)/libpostproc -Wl,-rpath-link,$(BUILD_ROOT)/libswscale -Wl,-rpath-link,$(BUILD_ROOT)/libavfilter -Wl,-rpath-link,$(BUILD_ROOT)/libavdevice -Wl,-rpath-link,$(BUILD_ROOT)/libavformat -Wl,-rpath-link,$(BUILD_ROOT)/libavcodec -Wl,-rpath-link,$(BUILD_ROOT)/libavutil -Wl,-Bsymbolic
