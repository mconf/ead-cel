#!/bin/bash
#bash script para analizar o crash log que da no logcat
#Instrucoes 
#1- copie a mensagem de crash para o arquivo a
#2- go to the Eadcel project directory and run ./stack.sh <caminho para a lib.so que deu erro> (if it doesnt work, run "chmod +x stack.sh" first)
